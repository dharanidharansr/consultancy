    ...
    <footer className="bg-gray-50 text-gray-600">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed">
              Glossary Mart brings fresh groceries and daily essentials right to
              your door. Quality products, great prices, and fast delivery.
            </p>
      ...
      <div className="px-4 sm:px-6 md:px-12 lg:px-16 py-5 text-xs sm:text-sm text-gray-500">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <p>
            © {new Date().getFullYear()} Glossary Mart. All rights reserved.
          </p>
          <p>
