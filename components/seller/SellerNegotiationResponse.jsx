                    ...
                    {!showCounterOfferForm && (
                        <div className="mt-4 flex flex-wrap gap-2">
                            ...
                            <button
                                ...
                                disabled={isSubmitting}
                                className={`px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''
                                    }`}
                            >
                                Make New Offer
                            </button>
                        ...
                        <div className="mt-4 p-4 bg-white rounded-lg border border-gray-200">
                            ...
                            <div className="mb-3">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 text-sm border border-orange-300 rounded-md focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                    min="1"
                                    required
                                />
                            ...
                            <div className="mt-3 flex gap-2">
                                <button
                                    ...
                                    className={`px-4 py-2 bg-orange-600 text-white text-sm rounded hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 ${(isSubmitting || !counterOfferAmount || parseFloat(counterOfferAmount) <= 0)
