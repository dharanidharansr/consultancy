    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 sm:px-6 md:px-16 lg:px-32 py-3 border-b border-gray-300 text-gray-700 bg-white">
        ...
        <div className="flex items-center gap-4 lg:gap-8 max-md:hidden">
          ...
          {(isAdmin || isSeller) && (
            <Link href="/owner" className="text-xs border border-orange-200 bg-orange-50 text-orange-700 px-4 py-1.5 rounded-full hover:bg-orange-100 cursor-pointer inline-block font-medium">
              Owner Dashboard
            </Link>
          )}
