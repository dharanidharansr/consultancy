                                                ...
                                                <tr key={order._id || index} className="border-t border-gray-200">
                                                    ...
                                                    <td className="px-4 py-3 space-x-2 flex flex-wrap gap-2">
                                                        ...
                                                        {getNextStatus(order.status) && (
                                                            <button
                                                                className="bg-orange-600 text-white px-3 py-1.5 rounded text-xs hover:bg-orange-700 transition"
                    ...
                    <div className="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <button
                                    className="flex-1 px-4 py-2 bg-orange-600 text-white rounded hover:bg-orange-700 transition text-sm font-medium disabled:bg-gray-400"
