...
const CustomDesignsPage = () => {
    ...
    const fetchDesignRequests = useCallback(async (page = 1, status = 'all') => {
        try {
            ...
            if (data.success) {
                ...
                toast.error(data.message || 'Failed to fetch special orders');
                setDesignRequests([]);
            }
        } catch (error) {
            if (error.response) {
                ...
                toast.error('Failed to fetch special orders');
            }
    ...
    const convertToOrder = async (designId) => {
        try {
            ...
            if (data.success) {
                ...
                toast.error(data.message || 'Failed to convert request to order');
            }
        } catch (error) {
            if (error.response) {
                toast.error(error.response.data?.message || 'Failed to convert request to order');
            } else {
                toast.error('Failed to convert request to order. Please try again.');
            }
        } finally {
    ...
    return (
        <div className="w-full p-8 bg-gray-50">
            <h1 className="text-2xl font-bold mb-6">Special Orders</h1>
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-lg shadow p-6 text-center">
                    <p className="text-lg text-gray-500">No special orders found</p>
                </div>
            ) : (
                <>
                                    ...
                                    <tr key={request._id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="text-sm text-gray-900">
                                                <span className="font-medium">Size/Pack:</span> {request.size}
                                            </div>
                                            <div className="text-sm text-gray-900">
                                            ...
                                            {request.preferredColor && (
                                                <div className="text-sm text-gray-900">
                                                    <span className="font-medium">Variant:</span> {request.preferredColor}
                                                </div>
                                            )}
                                        </td>
                                        <td className="px-6 py-4">
                ...
                <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-0">
                        <div className="flex justify-between items-center border-b p-6">
                            <h3 className="text-lg font-medium text-gray-900">Special Order Details</h3>
                            <button
                            ...
                            <div className="flex flex-col md:flex-row md:space-x-6">
                                        ...
                                        {activeRequest.status === 'approved' && !activeRequest.orderId && (
                                            <div className="mt-4">
                                                ...
                                                <p className="mt-2 text-xs text-gray-500">
                                                    This will create an order for the customer and mark this request as completed.
                                                </p>
                                            </div>
                                        )}
                                ...
                                <div className="md:w-1/2">
                                    <div className="grid grid-cols-2 gap-4 mb-6">
                                        ...
                                        <div>
                                            <h4 className="text-sm font-medium text-gray-500">Size/Pack</h4>
                                    ...
                                    <div className="mb-6">
                                        <h4 className="text-sm font-medium text-gray-500">Request Description</h4>
