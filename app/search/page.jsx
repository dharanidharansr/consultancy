...
const SearchResults = () => {
    ...
    }, [query, selectedCategories, sortOption, priceRange, searchProducts]);
    ...
    const getMetadataTitle = () => {
        ...
        return components.length > 0
            ? `${components.join(' - ')} | Glossary Mart`
            : "Search Products | Glossary Mart";
    };

    const getMetadataDescription = () => {
        if (query) {
            let description = `Browse search results for "${query}" at Glossary Mart.`;
        ...
        return "Search for grocery products, fresh produce, and daily essentials at Glossary Mart. Find exactly what you're looking for.";
    };
