...
const OrderDetailsContent = () => {
    ...
    return (
        <>
            <Navbar />
            <SEOMetadata
                title="Order Details | Glossary Mart"
                description="View your order details, status timeline, and delivery information."
                keywords="order details, order status, grocery delivery tracking"
                url="/order-details"
                noindex={true}
            />
                                    ...
                                    <div key={idx} className="flex gap-3 rounded-xl border border-gray-100 bg-white p-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs text-gray-600 mt-1">
                                                {item.color ? `Variant: ${item.color}` : 'Variant: —'}
                                                {' • '}
                                                {item.size ? `Pack: ${item.size}` : 'Pack: —'}
                                            </p>
