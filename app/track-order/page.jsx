...
const mockOrder = {
    ...
    items: [
        ...
        {
            id: 'p2',
            name: 'Glossary Mart Grocery Pack',
...
const OrderItem = ({ item }) => (
    <div className="flex gap-3 rounded-xl border border-gray-100 bg-white p-3">
        ...
        <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-600 mt-1">Pack: {item.size} • Variant: {item.color} • Qty: {item.qty}</p>
        </div>
...
const TrackOrderContent = () => {
    ...
    return (
        <>
            <Navbar />
            <SEOMetadata
                title="Track Order | Glossary Mart"
                description="Track your Glossary Mart order status and delivery details."
