        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Pack: {item.size} • Variant: {item.color}
            </p>
          </div>
...
const OrderPlaced = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20 md:pt-24 pb-28 md:pb-16">
      <SEOMetadata
        title="Order Confirmed | Glossary Mart"
        description="Your order has been confirmed. Thank you for shopping with Glossary Mart!"
