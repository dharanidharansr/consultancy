...
const MyDesignsPage = () => {
    ...
    return (
        <>
            <SEOMetadata
                title="My Custom Orders | Glossary Mart"
                description="View your custom order requests and check seller responses, quotes, and order status."
                keywords="custom orders, bulk orders, grocery requests, my orders"
                url="/my-designs"
            />
            <Navbar />
            ...
            <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 pt-20 md:pt-24">
                <div className="max-w-5xl mx-auto">
                    <div className="flex justify-between items-center mb-8">
                        <h1 className="text-3xl font-bold text-gray-900">My Special Orders</h1>
                    ...
                    {loading ? (
                        ...
                        <div className="bg-white rounded-lg shadow p-8 text-center">
                            ...
                            <h2 className="text-xl font-medium text-gray-700 mb-2">No Special Orders Yet</h2>
                            <p className="text-gray-500 mb-6">You haven&apos;t submitted any special order requests.</p>
                            <Link href="/custom-design">
                                        ...
                                        <div className="md:w-3/4 p-6 flex-1 flex flex-col">
                                            ...
                                            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                                ...
                                                {request.preferredColor && (
                                                    <div>
                                                        <span className="font-medium text-gray-500">Preferred Variant:</span> {request.preferredColor}
                                                    </div>
                                                )}
                                            </div>
                ...
                <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto p-0">
                        <div className="flex justify-between items-center border-b p-6">
                            <h3 className="text-lg font-medium text-gray-900">Order Request Details</h3>
                            <button
                        ...
                        <div className="p-6">
                                ...
                                <div className="md:w-1/2">
                                    <div className="grid grid-cols-2 gap-4 mb-6">
                                        ...
                                        {activeRequest.preferredColor && (
                                            <div>
                                                <h4 className="text-sm font-medium text-gray-500">Preferred Variant</h4>
                                                            ...
                                                            <div className="mt-4 border-t pt-4">
                                                                <div className="bg-yellow-50 p-3 rounded-md mb-3 border border-yellow-100">
                                                                    <p className="text-sm text-yellow-700">
                                                                        <span className="font-medium">Payment Required:</span> Please complete your payment to begin processing your custom order.
                                                                    </p>
                                                                </div>
                                                                <button
                                                                    onClick={() => {
                                                                        ...
                                                                        setTimeout(() => {
                                                                            ...
                                                                            modalContent.innerHTML = `
                                                                                ...
                                                                                <p>Loading payment interface for your custom order...</p>
                            ...
                            <div className="mt-8 p-4 bg-gray-50 rounded-lg">
                                ...
                                {activeRequest.status === 'pending' && (
                                    <p className="text-sm text-gray-700">
                                        Your order request is currently being reviewed by our team. We&apos;ll provide a quote soon.
                                    </p>
                                )}

                                {activeRequest.status === 'quoted' && (
                                    <p className="text-sm text-gray-700">
                                        We&apos;ve provided a quote for your order. Please review and accept it to proceed with production.
                                ...
                                {activeRequest.status === 'approved' && (
                                    <p className="text-sm text-gray-700">
                                        Your order has been approved and is now being processed. We&apos;ll update you when it&apos;s ready.
                                    </p>
                                )}

                                {activeRequest.status === 'rejected' && (
                                    <p className="text-sm text-gray-700">
                                        Unfortunately, we couldn&apos;t proceed with your request. Please check the seller&apos;s response
                                        for details or submit a new request.
                                    </p>
                                )}

                                {activeRequest.status === 'completed' && (
                                    <p className="text-sm text-gray-700">
                                        Your custom order has been completed! If you have any questions about your order,
                                        please contact us.
                                    </p>
                                )}
                            </div>
