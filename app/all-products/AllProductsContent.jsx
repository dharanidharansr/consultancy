...
function AllProductsContent() {
    ...
    const getSeoTitle = () => {
        let title = "All Products | Glossary Mart";

        if (searchTerm) {
            return `Search Results for "${searchTerm}" | Glossary Mart`;
        }
        ...
        if (filters.length > 0) {
            return `${filters.join(', ')} | Glossary Mart`;
        }

        if (showFavorites) {
            return "My Favorite Products | Glossary Mart";
        }
    ...
    const getSeoDescription = () => {
        if (searchTerm) {
            return `Browse products matching "${searchTerm}" at Glossary Mart. Find the best groceries and essentials.`;
        }
        ...
        if (filters.length > 0) {
            return `Browse our selection of ${filters.join(' and ')} products at Glossary Mart. Quality groceries and essentials.`;
        }

        if (showFavorites) {
            return "View your favorite products at Glossary Mart. Shop your saved grocery items.";
        }

        return "Browse our extensive collection of grocery products suitable for your daily needs at Glossary Mart.";
    };
