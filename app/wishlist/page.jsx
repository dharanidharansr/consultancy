...
const WishlistPage = () => {
        ...
        try {
            const response = await fetch('/api/wishlist/share', {
                ...
                body: JSON.stringify({
                    ...
                    userName: user?.firstName ? `${user.firstName}` : 'A Glossary Mart User',
    ...
    if (!user) {
        return (
            <>
                <Navbar />
                <SEOMetadata
                    title="Sign In Required | Glossary Mart"
    ...
    return (
        <>
            <Navbar />
            <SEOMetadata
                title="My Wishlist | Glossary Mart"
                description="View and manage your saved favourite products at Glossary Mart. Shop your wishlist items and discover new arrivals."
                keywords="wishlist, favourites, saved products, grocery products, glossary mart"
                url="/wishlist"
            />
