...
const CustomDesignPage = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            try {
                ...
                toast.success('Special order request submitted successfully! You will receive a quote from our team soon.');
    ...
    return (
        <>
            <SEOMetadata
                title="Special Order Request | Glossary Mart"
                description="Request a custom order or bulk purchase. Upload your requirements and we'll fulfill your needs."
                keywords="custom order, bulk order, grocery request, special order"
                url="/custom-design"
            />
            <Navbar />
            ...
            <div className="min-h-screen bg-gradient-to-br from-white to-gray-100 py-12 px-4 sm:px-6 lg:px-8 pt-20 md:pt-24">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl font-bold text-gray-900 mb-4">Request Special Order</h1>
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Upload an image reference or list, tell us about your requirements, and we&apos;ll create a custom order just for you!
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        <div className="md:flex">
                            ...
                            <div className="md:w-1/2 bg-gray-50 p-8 flex flex-col items-center justify-center border-r border-gray-200">
                                <h2 className="text-2xl font-semibold mb-6 text-gray-800">Upload Reference Image</h2>
                                ...
                                <p className="text-sm text-gray-500 text-center mt-2">
                                    Upload a clear image of your requirements (e.g. shopping list, product photo). We recommend high-resolution images for best results.
                                </p>
                            </div>
                            ...
                            <div className="md:w-1/2 p-8">
                                ...
                                <form onSubmit={handleFormSubmit}>
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                rows={4}
                                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                                placeholder="Describe your request, items needed, or any special instructions..."
                                                required
                                            ></textarea>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Pack/Size Preference</label>
                                                <select
                                                    name="size"
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Preferred Variant/Brand</label>
                                            <input
                                                type="text"
                                                name="preferredColor"
                                                ...
                                                onChange={handleInputChange}
                                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                                                placeholder="e.g., Organic, Specific Brand, etc."
                                            />
                                        </div>
                                    ...
                                    <div className="mt-6">
                                        ...
                                        >
                                            {isSubmitting ? 'Submitting...' : 'Submit Special Order Request'}
                                        </button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div className="mt-16">
                        ...
                        <div className="grid md:grid-cols-4 gap-6">
                            <div className="bg-white p-6 rounded-lg shadow-md text-center">
                                ...
                                <h3 className="text-lg font-semibold mb-2">1. Submit Your Request</h3>
                                <p className="text-gray-600">Upload your list/image and tell us about your requirements.</p>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md text-center">
                                ...
                                <p className="text-gray-600">Our team will review your request and provide a quote based on your items.</p>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow-md text-center">
                                ...
                                <h3 className="text-lg font-semibold mb-2">4. Receive Your Order</h3>
                                <p className="text-gray-600">We&apos;ll pack and ship your order after payment is confirmed.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md overflow-hidden">
                            <dl className="divide-y divide-gray-200">
                                ...
                                <div className="px-6 py-4">
                                    ...
                                    <dd className="mt-2 text-gray-600">We typically respond within 24-48 hours with a quote for your custom request.</dd>
                                </div>
                                <div className="px-6 py-4">
                                    <dt className="text-lg font-semibold text-gray-900">What&apos;s the minimum order quantity?</dt>
                                    <dd className="mt-2 text-gray-600">Our minimum order is 1 item for custom requests.</dd>
                                </div>
                                <div className="px-6 py-4">
                                    <dt className="text-lg font-semibold text-gray-900">Can I see a preview before production?</dt>
                                    <dd className="mt-2 text-gray-600">Yes, we&apos;ll send you a list of items for approval before packing begins.</dd>
                                </div>
                                <div className="px-6 py-4">
